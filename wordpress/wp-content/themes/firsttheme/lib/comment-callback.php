    ...
    <<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class(['c-comment', $comment->comment_parent ? 'c-comment--child' : '']); ?>>
        <article id="div-comment-<?php comment_ID(); ?>" class="c-comment__body">
            ...
            <?php if ($args['avatar_size'] != 0) {
                echo get_avatar($comment, $args['avatar_size'], false, false, [
                    'class' => 'c-comment__avatar',
                ]);
            } ?>
            <?php edit_comment_link(
                esc_html__('Edit Comment', '_themename'),
            ...
            <div class="c-comment__content">
                ...
                <a class="c-comment__time" href="<?php echo esc_url(
                ...
                <?php if ($comment->comment_approved == '0') { ?>
                    <p class="c-comment__awaiting-moderation"><?php esc_html_e(
